...
export const projects: ProjectItem[] = [
  { id: 'sun-pharma', title: 'Sun Pharma Industries Ltd', location: 'Ankleshwar · Panoli · Dahej', image: '/img/1.jpg' },
  { id: 'neogen', title: 'Neogen Chemicals Ltd', location: 'SEZ-2 · Dahej', image: '/img/2.jpg' },
  { id: 'borosil', title: 'Borosil Renewables Ltd', location: 'Jhagadia', image: '/img/3.jpg' },
  { id: 'meghmani', title: 'Meghmani Novotech Pvt Ltd', location: 'Dahej', image: '/img/4.jpg' },
  { id: 'aarti', title: 'Aarti Industries (Sub contractor)', location: 'Jhagadia · Dahej', image: '/img/5.jpg' },
  { id: 'ganga', title: 'Ganga Rasayanie Pvt Ltd', location: 'Dahej', image: '/img/6.jpg' },
  { id: 'mrf', title: 'MRF Tyre Ltd', location: 'Dahej', image: '/img/7.jpg' },
  { id: 'akshar-chem-a', title: 'Akshar Chem (India) Ltd', location: 'Dahej', image: '/img/8.jpg' },
  { id: 'akshar-chem-b', title: 'Akshar Chem (India) Ltd', location: 'Dahej', image: '/img/9.jpg' },
  { id: 'akshar-chem-c', title: 'Akshar Chem (India) Ltd', location: 'Dahej', image: '/img/10.jpg' }
]
